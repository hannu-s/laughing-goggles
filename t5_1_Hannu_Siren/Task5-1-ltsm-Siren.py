...
data_path = "D:/jyu/TIES4911 Deep-Learning for Cognitive Computing for devs/Task 5 2/simple-examples/data"
...
if args.run_opt == 1:
    train(train_data, vocabulary, num_layers=2, num_epochs=2, batch_size=20,
          model_save_name='two-layer-lstm-medium-config-2-epoch-0p93-lr-decay-10-max-lr')
else:
    trained_model = args.data_path + "\\two-layer-lstm-medium-config-2-epoch-0p93-lr-decay-10-max-lr-final"
